                            ...
                            @foreach ($courier as $item)
                                <tr class="data-row">
                                    ...
                                    <td>
                                        ...
                                        <form action="/admin/courier/{{$item->id}}" method="POST" id="form_delete" class="btn-group">
                                            @csrf
                                            @method("DELETE")
            ...
            <form action="/admin/courier" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="courier" class="form-control" placeholder="Courier Name" />
                    </div>
                ...
                <form id="edit-form"  method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="courier" class="form-control" id="modal-edit-courier" required autofocus>
                        </div>
                    </div>
                    <div class="modal-footer">
...
$(document).ready(function() {
    ...
    */
    ...
    $('#modal-default').on('show.bs.modal', function() {
        ...
        var courier = row.children(".courier").text();
        $("#edit-form").attr('action', '/admin/courier/'+id);
        // fill the data in the input fields
        
        $("#modal-edit-courier").val(courier);
